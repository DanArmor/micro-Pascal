...
template<typename U>
Node<U>::Node(U const value) : nextPtr(nullptr), prevPtr(nullptr), innerData(value){};
...
template<typename T>
List<T>::List() : sizeOfList(0), startPtr(nullptr), endPtr(nullptr), workPtr(nullptr), currIndex(0) {};

template<typename T>
List<T>::List(std::initializer_list<T> const &initData) : sizeOfList(0), startPtr(nullptr), endPtr(nullptr), workPtr(nullptr), currIndex(0) {
...
template<typename T>
List<T>::List(std::vector<T> const &initData) : sizeOfList(0), startPtr(nullptr), endPtr(nullptr), workPtr(nullptr), currIndex(0) {
    for(auto value : initData)
        pushBack(value);
    sizeOfList = initData.size();
}
...
template<typename T>
List<T>::List(std::size_t n) : sizeOfList(0), startPtr(nullptr), endPtr(nullptr), workPtr(nullptr), currIndex(0) {
...
template<typename T>
List<T>::List(List<T> const &list): sizeOfList(0), startPtr(nullptr), endPtr(nullptr), workPtr(nullptr), currIndex(0){
    clear();
    for(auto x : list)
        pushBack(x);
}
